...
const client_1 = __nccwpck_require__(1497);
var ACTION;
(function (ACTION) {
    ACTION["PUSH"] = "push";
    ACTION["PULL"] = "pull";
...
;// CONCATENATED MODULE: ./src/lokalise/base/client.ts
...
;// CONCATENATED MODULE: ./src/lokalise/push/client.ts
var push_client_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class LokalisePushClient extends LokaliseClient {
     ...
     */
    pushKeys() {
        return push_client_awaiter(this, void 0, void 0, function* () {
            try {
...
"use strict";
module.exports = JSON.parse('{"name":"lokalise-actions","version":"0.0.0","private":true,"description":"Push to and pull from Lokalise","main":"lib/main.js","scripts":{"build":"tsc","format":"prettier --write **/*.ts","format-check":"prettier --check **/*.ts","lint":"eslint src/**/*.ts","package":"ncc build --source-map --license licenses.txt","test":"jest","all":"npm run build && npm run format && npm run lint && npm run package && npm test"},"repository":{"type":"git","url":"git+https://github.com/color/lokalise-actions.git"},"keywords":["actions","node","setup"],"author":"","license":"MIT","dependencies":{"@actions/core":"^1.4.0","@lokalise/node-api":"^6.2.1","pofile":"^1.1.1"},"devDependencies":{"@types/jest":"^26.0.23","@types/node":"^14.14.9","@typescript-eslint/parser":"^4.28.2","@vercel/ncc":"^0.28.6","eslint":"^7.29.0","eslint-plugin-github":"^4.1.3","eslint-plugin-jest":"^24.3.6","jest":"^26.6.3","jest-circus":"^26.6.3","js-yaml":"^3.14.0","prettier":"2.3.2","ts-jest":"^26.5.6","typescript":"^4.3.5"}}');
